...
{$ELSE}
  ...
  function alutLoadWAVFile(fname: string; var format: TALenum; var data: TALvoid; var size: TALsizei; var freq: TALsizei; var loop: TALint) : boolean;
  function alutLoadWAVMemory(memory: PALbyte; var format: TALenum; var data: TALvoid; var size: TALsizei; var freq: TALsizei; var loop: TALint) : boolean;
...
begin
  ...
  result := LoadWavStream(Stream, format, data, size, freq, loop);
  Stream.Free;
end;
